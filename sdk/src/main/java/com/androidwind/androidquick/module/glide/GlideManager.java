...
public class GlideManager {
    ...
    public static void loadNet(String url, ImageView imageView) {
        load(Glide.with(imageView.getContext()).load(url), null).into(imageView);
    }

    public static void loadNet(String url, ImageView imageView, LoadOption loadOption) {
    ...
    public static void loadRes(int resId, ImageView imageView, LoadOption loadOption) {
        load(Glide.with(imageView.getContext()).load(resId), loadOption).into(imageView);
    }

    public static void loadAsset(String assetName, ImageView imageView) {
        load(Glide.with(imageView.getContext()).load("file:///android_asset/" + assetName), null).into(imageView);
    }

    public static void loadAsset(String assetName, ImageView imageView, LoadOption loadOption) {
    ...
    public static void loadFile(File file, ImageView imageView, LoadOption loadOption) {
    ...
    public static void downLoadImage(final Context context, final String url, final File targetFile, final ImageListener<File> imageListener) {
    ...
    public static void clearMemoryCache(final Context mContext) {
    ...
    private static RequestBuilder load(RequestBuilder requestBuilder, LoadOption loadOption) {
...
//                circleTransformation = new CropCircleTransformation();
    ...
    private static MultiTransformation getMultiTransformation(Transformation... transformations) {
